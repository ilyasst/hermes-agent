...
def read_file_tool(path: str, offset: int = 1, limit: int = 500, task_id: str = "default") -> str:
    ...
    try:
        ...
        if content_len > max_chars:
            ...
            # [LOCAL Patch J] Remember where the next unseen window starts so a
            # repeated default/top read auto-advances (see Auto-advance block
            # above). Bounded: drop the whole per-task map if it grows large.
            with _read_tracker_lock:
